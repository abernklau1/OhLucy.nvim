...
M.plugins = {
  ...
  -----------------------------------------
  ["@annotation"]            = { fg = colors.pink }, -- orginal yellow
  ...
  ["@string.regex"]          = { fg = colors.pink }, -- original yellow
  ["@text.strong"]           = { fg = colors.yellow }, -- original yellow
